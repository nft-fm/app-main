...
const MusicPlayer = (props) => {
  ...
  const startRemainingSong = () => {
    if (bufferSrc.context.currentTime >= bufferSrc.buffer.duration) {
        ...
        const remainingBuffer = fullBufferSrc;
        remainingBufferSrc.buffer = _buffer;
        remainingBufferSrc.connect(gainNode);
        remainingBufferSrc.start(currentTime, currentTime);
