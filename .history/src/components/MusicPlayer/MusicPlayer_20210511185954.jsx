...
const MusicPlayer = (props) => {
  ...
  const [isStartingRemainingSong, setIsStartingRemainingSong] = useState(false);
  ...
  const startRemainingSong = () => {
    if (bufferSrc.context.currentTime >= bufferSrc.buffer.duration) {
        setIsStartingRemainingSong(true)
  ...
  useEffect(() => {
    ...
    if (isPlaying) {
      intervalId = setInterval(() => {
        ...
        if (isStartingRemainingSong && bufferSrc.context.currentTime >= bufferSrc.buffer.duration) {
    ...
    else if (!isStartingRemainingSong && bufferSrc && bufferSrc.context &&
