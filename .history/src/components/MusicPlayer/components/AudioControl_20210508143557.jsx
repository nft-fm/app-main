...
const MusicPlayer = (props) => {
  ...
  return (
        <AudioControlSection>
          ...
          <img src={SkipBackwardIcon} onClick={() => props.skipTime(10, false)} />
            {!props.isPlaying ?
                <img src={PlayIcon} onClick={() => props.playSong()} />
                :
                <img src={PauseIcon} onClick={() => props.stopSong()} />
            }
          <img src={SkipForwardIcon} onClick={() => props.skipTime(10, true)} />
          <img src={NextIcon} onClick={() => {}} />
        </AudioControlSection>
  )
}
