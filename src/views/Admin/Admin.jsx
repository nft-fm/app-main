...
import { buyNFT, fetchNFTApproved, approveNFT, getDCBalance, getLootboxPrice, fetchBDTStaked, getPendingNFTs, redeemNFT } from "../../web3/utils";
            ...
            <CardContainer>
              ...
              {account ?
                (<>
                  ...
                  <input placeholder="picture" onChange={(e) => setPicture(e.target.value)} />
                  <input placeholder="name" onChange={(e) => setName(e.target.value)} />
                  <input type="number" onChange={(e) => setAssetID(e.target.value)} />
                  <button onClick={uploadNFT}>submit</button>
                  {nfts.map(nft => {
