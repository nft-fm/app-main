    ...
    <BaseView>
      <Container>
        ...
        <SectionContent>
          ...
          services operated by FANFARE, including our website www.nftfm.io (the
          ...
          Policy that materially affect how your personal information is stored,
          accessed, and processed. As such, you should read our Privacy Policy
          in addition to this ToU.
        </SectionContent>
        <SectionTitle>Acceptance of Terms of Use</SectionTitle>
        <SectionContent>
          We know these ToU’s aren’t very exciting to read. However, by
          accessing our Services, it is assumed that you have read this ToU and
          that you agree to comply and be legally bound by the terms and
          conditions set out, which is why you really should stick it out and
          read the whole thing. You should also head over and check out our
          Privacy Policy as well.
        </SectionContent>
        <SectionTitle>Changes to Terms</SectionTitle>
        <SectionContent>
          From time to time, we may need to make changes to this ToU and may do
          so at any time. The date at the top of this ToU represents when this
          ToU was last revised. It is important to check this ToU from time to
          time to ensure that you are all caught up to date. By continuing to
          access or use our Services after a change has occurred, you agree to
          be bound by our updated ToU.
        </SectionContent>
        ...
        <SectionContent>
          ...
          directly via our Site. Users can also “like” and share on their social
          media non-fungible tokens featured on our Site. From time to time, we
          may introduce new services and features, which will also be subject to
          this ToU.
          <br />
          <br />
          <ul>
            <li>
              <ListItemTitle>What are Non-Fungible Tokens?</ListItemTitle>
              <br />
              “Non-fungible tokens” are built up of data that are then stored on
              the blockchain (a digital ledger). The word fungible means
              interchangeable or replaceable; so a token that is non-fungible is
              a token that can’t be replaced: it’s unique. Non-fungible tokens
              can be used to store artwork, music, animations, videos, VIP
              tickets, signatures… pretty much anything! When a person purchases
              that non-fungible token, they are purchasing a unique version of
              the content.
            </li>
            <br />
            <li>
              ...
              sale agreement between Artists and Users.
            </li>
          </ul>
        </SectionContent>
        ...
        <SectionContent>
          ...
          create a non-fungible token on our Site or a User that wants to make a
          purchase or interact by liking or sharing non-fungible tokens
          available on our Site, you will need to connect to our Site through
          the MetaMask extension. MetaMask allows you to link your existing
          cryptocurrency wallets, create a cryptocurrency wallet, and purchase,
          store and engage in transactions using Ethereum cryptocurrency. Need
          help? We have some guides and videos available on our Site to help you
          with this process.
          <br />
          <br />
          <ul>
            <li>
              <ListItemTitle>Artist Creations</ListItemTitle>
              <br />
              If you are an Artist and would like to create non-fungible tokens
              on our Site, you will need to be verified manually through our
              systems and must sign and comply with our Services & Artist
              Licensing Agreement. Currently, we are only accepting limited
              Artists to use our Site, but you can reach out to us directly at
              info@nftfm.io if you have interest in our Services.
            </li>
            <br />
            <li>
              <ListItemTitle>User Purchases and Interactions</ListItemTitle>
              <br />
              Once you have successfully linked your MetaMask account to our
              Site, you will be able to purchase non-fungible tokens (provided
              you have enough cryptocurrency available in your account) and
              interact by sharing or liking non-fungible tokens available on our
              Site. Any purchases and interactions that occur on our Site are
              completed via an automated online process.
            </li>
          </ul>
        </SectionContent>
        <SectionTitle>Non-Fungible Token Purchases</SectionTitle>
        <SectionContent>
        ...
        <SectionContent>
          ...
          will always be notified if a feature you wish to use on our Site is a
          paid feature. There also may come a time when we need to charge a fee
          for our Site or may need to make changes to our pricing; as such,
          prices advertised are not guaranteed. Payment for features are due
          upon confirmation of a purchase. Additionally, when a purchase of a
          non-fungible token is made, a small commission-based fee is sent to us
          at the same time the payment is made to the Artist.
        </SectionContent>
        ...
        <SectionContent>
          ...
          <ul>
            <li>
              Determining and complying with all laws and regulations that may
              relate to your use of cryptocurrency per your jurisdiction of
              residence, including, but not limited to, securities and tax laws;
            </li>
            <li>
              Ensuring that the third-party cryptocurrency wallet you choose to
              use is reliable, secure, and resistant to cyber-attacks and fraud;
              and
            </li>
            <li>
              Ensuring that your cryptocurrency wallet keys and MetaMask account
              password, and Seed Phrase are held in a secure place and are not
              susceptible to being misplaced or stolen.
            </li>
          </ul>
        </SectionContent>
        ...
        <SectionContent>
          ...
          <ul>
            <li>
              use any automated means (including bots, scrapers, and spider) to
            ...
            <li>
              use or attempt to use unauthorized third parties to connect to our
              Services;
            </li>
            <li>
              share your private wallet keys or MetaMask passwords or seed
              phrases with others;
            </li>
            <li>
              use any other individual’s cryptocurrency wallet or MetaMask
              account to access our Services;
            </li>
            <li>
              remove or alter any intellectual property notices, including for
              the purpose of changing the source of ownership of any content
              featured;
            </li>
            <li>
              connect another MetaMask account once we’ve disconnected a
              previous one you were using;
            </li>
            <li>buy, sell, lease or rent your MetaMask account;</li>
            <li>
            ...
            <li>
              ...
              that you have not secured the rights, licenses, and appropriate
              authorizations in;
            </li>
            <li>
              upload or share any content that infringes or violates the rights
              of any third-party, including, without limitation, any
              intellectual property rights, performers’ rights, rights of
              privacy, rights in contract, rights of publicity, or rights in
              confidential information;
            </li>
            <li>
              upload or share any content that is unlawful, abusive, defamatory,
              pornographic, or obscene; and
            </li>
            <li>
              upload or share any content that promotes or incites violence,
        ...
        <SectionTitle>Suspension and Termination of Users</SectionTitle>
        <SectionContent>
          <ul>
            <li>
              ...
              your access to our Services without warning at any time.
            </li>
            <br />
            <li>
              <ListItemTitle>Voluntary Termination</ListItemTitle>
              <br />
        ...
        <SectionContent>
          ...
          policy to respond to and investigate any claim that content posted on
          our Services infringes on the copyright or other intellectual property
          ...
          <ul>
            ...
            <li>
              identification of the URL or other specific location on our
              Platform where the material that you claim is infringing is
              located;
            </li>
            ...
            <li>
              ...
              copyright owner or authorized agent permitted to act on the
        ...
        <SectionContent>
          ...
          DOES NOT TRANSFER INTELLECTUAL PROPERTY OWNERSHIP RIGHTS IN SUCH
          MATERIAL OR CONTENT AND THAT YOU DO NOT HAVE REPRODUCTION RIGHTS OR
          ANY OTHER RIGHTS REGARDING THE MATERIAL OR CONTENT BEYOND OWNERSHIP OF
          TITLE IN THAT SINGLE NON-FUNGIBLE TOKEN.
        </SectionContent>
        ...
        <SectionContent>
          <ul>
            ...
            <ul>
              <li>
                You are free to enter into and comply with this ToU and our
                Privacy Policy and are not under any disability, restriction, or
                prohibition, contractual or otherwise, that prevents you from
                entering into this ToU and our Privacy Policy;
              </li>
              <li>
              ...
              <li>
                You assume all risks associated with cryptocurrency use and
                investment.
              </li>
            </ul>
          </ul>
        ...
        <SectionContent>
          ...
          PLATFORM, TEMPORARY OR PERMANENT SUSPENSION OF SERVICES, DAMAGE TO
          COMPUTER OR HARDWARE, SECURITY BREACHES, INTERRUPTION OF BUSINESS,
          LOST PROFITS, BREACH OF A THIRD-PARTY CONTRACT, OR ANY INDIRECT,
        ...
        <SectionContent>
          ...
          <br />
          <ul>
            <li>any breach by you of this ToU or our Privacy Policy;</li>
            <li>
              any third-party claim arising from your creation, uploading, or
              sharing of content through our Services including, but not limited
              to, claims of copyright infringement, trademark infringement,
              right of publicity, rights of privacy, breach of contract,
              defamation, fraud, misrepresentation, inaccuracy, discrimination,
              abuse, pornography or obscenity;
            </li>
            <li>
              any activity related to your interaction with our Services; and
            </li>
            <li>
              any investigation or claims brought as a result of your breach of
              tax and securities laws and regulations.
            </li>
          </ul>
        </SectionContent>
        ...
        <SectionTitle>Use by Minors</SectionTitle>
        <SectionContent>
          ...
          guardian before accessing our Services. A parent or guardian who has
          permitted a minor to access our Services agrees to this ToU on behalf
          of the minor and is solely responsible for exercising supervision over
          the minor’s activities while using our Services. Please see our
          Privacy Policy for more information relating to our policy for dealing
          with personal information inadvertently collected from minors.
        </SectionContent>
        ...
        <SectionContent>
          ...
          States export controls. We reserve the right to limit our Services, in
          whole or in part, to any geographic location or jurisdiction we
          choose.
        </SectionContent>
        <SectionTitle>Dispute Resolution</SectionTitle>
        <SectionContent>
          THIS SECTION OF OUR ToU SIGNIFICANTLY AFFECTS YOUR LEGAL RIGHTS,
          INCLUDING YOUR RIGHT TO FILE A LAWSUIT IN COURT. PLEASE ENSURE THAT
          YOU READ THIS SECTION CAREFULLY AND FULLY UNDERSTAND THIS SECTION
          BEFORE USING AND ACCESSING OUR SERVICES. THIS SECTION WILL SURVIVE
          TERMINATION OF THIS TOU, OUR PRIVACY POLICY, AND ANY TERMINATION OF
          ...
          <ul>
            ...
            <li>
              ...
              relating to infringement or misuse of intellectual property. The
              binding arbitration will be governed by the Commercial Arbitration
              Rules and the Supplementary Procedures for Consumer-Related
              Disputes of the American Arbitration Association (the “AAA”) and
              administered by the AAA. Arbitration must be commenced by filing a
              demand for arbitration with the AAA within one (1) year after the
              claim occurs or within one (1) year of the party asserting the
              claim becoming reasonably aware of the act or omission giving rise
              to the claim. If applicable law prohibits a one-year statute of
            ...
            <br />
            <li>
              <ListItemTitle>Class Action Waiver</ListItemTitle>
              <br />
        ...
        <SectionContent>
          All provisions in this ToU or Privacy Policy that specifically state
          or logically ought to survive the termination of our ToU or Privacy
          Policy, or the termination of a user’s access to our services will
          survive such termination, including without limitation arbitration,
          representations and warranties, indemnification, limitation of
          liability, intellectual property ownership, and arbitration
          provisions.
        </SectionContent>
        ...
        <SectionContent>
          ...
          term or condition in this ToU is declared to be invalid, illegal, or
          unenforceable, for any reason, the remainder of the provisions will
          remain in effect and will be enforceable to the fullest extent
          possible.
        </SectionContent>
        <SectionTitle>Applicable Law and Jurisdiction</SectionTitle>
        <SectionContent>
          Except where otherwise required by mandatory law, this ToU, as well as
          our Privacy Policy, are to be governed by and interpreted,
          constructed, and enforced in accordance with the laws of Delaware and
          in the exclusive jurisdiction of Delaware.
        </SectionContent>
