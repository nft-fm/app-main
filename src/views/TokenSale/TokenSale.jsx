...
const TokenSale = () => {
  const [isTimeForSale, setIsTimeForSale] = useState(false)
  useEffect(() => {
    const interval = setInterval(() => {
      if (moment().isAfter(1621443600000)) {
        setIsTimeForSale(true)
      }
    }, 1000);
  ...
  return (
    <BaseView>
      <BigContainer>
            <Disclaimer>
              <span>
                By purchasing $VINYL I acknowledge that this is a utility token,
                not an investment: it provides access to the community
                governance system.
              </span>
            </Disclaimer>
            <PrivateSale />
